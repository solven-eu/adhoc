...
- [Pivotable] Enable selection of `tag` without browsing measures (important when there are many measures)
- [Pivotable] Show selected options as tag, even when carousel is shrinked.
...
- [Pivotable] Enable column sorting.
