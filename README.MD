...
- Work on query cancellations/queryTimeouts
- Enables `getCoordinates` for cube.columns created by measures
- [SECURITY] Ability to hide some measures from some Users