...
See also:
- [Calculated Columns](calculated-columns.md) — overview of all column-generation approaches (`IDecomposition`, `FunctionCalculatedColumn`, `EvaluatedExpressionColumn`).
