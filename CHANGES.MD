...
## [0.0.7]
### Added
- `CachingTableWrapper` can be used to add a caching layer on top of a `ITableWrapper`
...
- Drops `CharSequence` as a priveledged type (e.g. in aggregations, in `IMultiTypeXXX`)
