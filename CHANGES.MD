...
- Additional `WorkCup` example cube, with more complex measures.

### Changed
- `toString()` of `IColumnMatcher` has multiple specialized implementations, depending on the matcher type.
