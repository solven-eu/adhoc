 ...
 * {@link Roaring64NavigableMap} as the implementation split the input long in two integers, one used as key of a
 * NavigableMap while the other is added in a Bitmap
 * 
 * @author Benoit Lacelle
 *
 */
// Duplicated from RoaringBitmap
public class LongAs2IntsPacking {
	 ...
	 * 
	 * @param high
	 *            an integer representing the highest order bits of the output long
	 * @param low
	 *            an integer representing the lowest order bits of the output long
	 * @return a long packing together the integers as computed by {@link LongAs2IntsPacking#high(long)} and
	 *         {@link LongAs2IntsPacking#low(long)}
	 */
