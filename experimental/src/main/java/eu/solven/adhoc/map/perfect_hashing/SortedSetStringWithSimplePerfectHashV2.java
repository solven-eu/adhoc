...
@Builder
public class SortedSetStringWithSimplePerfectHashV2 implements ISortedSetString {
	@Getter
	@Singular
	final ImmutableSortedSet<String> keys;
	final Supplier<SimplePerfectHashV2> hash = Suppliers.memoize(() -> {
		return new SimplePerfectHashV2(getKeys());
	});
