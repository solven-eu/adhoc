 ...
 *
 * <p>
 * cf. <a href="http://projects.csail.mit.edu/jacm/References/hsu1975:11.html">Harry Hsu. "An algorithm for finding a
 * minimal equivalent graph of a digraph.", Journal of the ACM, 22(1):11-16, January 1975.</a>
 * </p>
 *
 * <p>
 * This is a port from a python example by Michael Clerx, posted as an answer to a question about
 * <a href= "http://stackoverflow.com/questions/1690953/transitive-reduction-algorithm-pseudocode"> transitive reduction
 * algorithm pseudocode</a> on <a href="http://stackoverflow.com">Stack Overflow</a>
 * </p>
 *
...
public final class TransitiveReductionV2 {
	...
	public <V, E> void reduce(final Graph<V, E> directedGraph) {
		...
		// by the reduction. Iterating over originalMatrixCopy bits avoids the
		// O(n²) scan and the getEdge() calls for pairs that were never edges.
		for (int i = 0; i < n; i++) {
